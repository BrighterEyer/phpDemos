		...
		<div class="container">
			<form class="" method="post">
				<div class="form-group">
					...
					<input type="text" name="title"  value="" class="form-control" placeholder="请输入文章标题" />
				</div>
				...
				<div class="form-group">
					...
					<input type="text" name="thumb" value="" class="form-control" placeholder="请输入配图URL" />
				</div>
				...
				<div class="form-group">
					...
					<script type="text/plain" name="content" id="editor" name="content" ></script>
				</div>
